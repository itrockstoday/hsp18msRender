    ...
    ntfyPayload.actions = [
      {
        action: "view",
        label: "🔑 Disarm System",
        url: `${externalUrl}/verify-2fa?code=123456`
      },
      {
        action: "view",
        label: "🅿️ Set PARKED Mode",
        url: `${externalUrl}/set-mode?mode=PARKED&code=123456`
      },
      {
        action: "view",
        label: "🔓 Set OWNER Mode",
        url: `${externalUrl}/set-mode?mode=OWNER&code=123456`
      }
    ];
  }
